...
return [
    ...
    'welcome'      => [
        'templateTitle' => 'CMS',
        'title'         => 'CMS',
        'message'       => 'Welcome to CMS. Before getting started, we need some information on the database. You will need to know the following items before proceeding.',
        'next'          => 'Let\'s go',
    ],
    ...
    'create'                => 'Create',
    'install_success'       => 'Install CMS successfully!',

        ...
        $data = [
            'en_US' => [
                ...
                [
                    ...
                    'value' => 'With experience, we make sure to get every project done very fast and in time with high quality using our CMS https://1.envato.market/LWRBY',
                ],
                [
                    'key'   => 'phone',
                    'value' => '+(123) 345-6789',
            ...
            'vi' => [
                [
                    'key'   => 'site_title',
                    'value' => 'Một trang web sử dụng CMS',
                ],
                [
                    'key'   => 'copyright',
                ...
                [
                    'key'   => 'site_description',
                    'value' => 'Với kinh nghiệm dồi dào, chúng tôi đảm bảo hoàn thành mọi dự án rất nhanh và đúng thời gian với chất lượng cao sử dụng CMS của chúng tôi https://1.envato.market/LWRBY',
                ],
                [
                    'key'   => 'phone',
                    'value' => '+(123) 345-6789',
